...
def _parse_structured_message(message: dict[str, Any], response_model: type[T]) -> T:
    """Accept provider final text or misclassified reasoning text only when schema-valid."""
